...
namespace PKG_6
{
    public partial class Form1 : Form
    {
        ...
        public void plot(Graphics gr)
        {
            ...
            Pen[] pen = new Pen[3] { new Pen(Color.Purple, 3), new Pen(Color.Yellow, 3), new Pen(Color.Red, 3) };
            string[] str = new string[3] { "x", "y", "z" };
            Font font = new Font(this.Font, FontStyle.Italic);
            Pen GCS = new Pen(Color.DarkGreen, 3);
            PointF a, b;
            if (rbYes.Checked)
            {
        ...
        public void InitializeLetter()
        {
            ...
            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(1, 0, 0), new Coordinates(1, 1, 0)));
            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(1, 1, 0), new Coordinates(0, 1, 0)));
            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(0, 1, 0), new Coordinates(0, 0, 0)));

            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(0, 0, 0), new Coordinates(0, 0, 5)));
            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(0, 0, 5), new Coordinates(0, 1, 5)));
            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(0, 1, 5), new Coordinates(0, 1, 0)));

            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(0, 0, 5), new Coordinates(3, 0, 5)));
            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(3, 0, 5), new Coordinates(3, 0, 4)));
            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(3, 0, 4), new Coordinates(1, 0, 4)));
            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(1, 0, 4), new Coordinates(1, 0, 0)));

            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(0, 1, 5), new Coordinates(3, 1, 5)));
            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(3, 1, 5), new Coordinates(3, 1, 4)));
            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(3, 1, 4), new Coordinates(1, 1, 4)));
            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(1, 1, 4), new Coordinates(1, 1, 0)));

            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(1, 0, 4), new Coordinates(1, 1, 4)));
            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(3, 0, 4), new Coordinates(3, 1, 4)));
            letter.Add(new KeyValuePair<Coordinates, Coordinates>(new Coordinates(3, 0, 5), new Coordinates(3, 1, 5)));
        }
        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            PointF a, b;
            Pen pen = new Pen(Color.SkyBlue, 7);
        ...
        {
            pictureBox1.Size = new Size(Width, Height - 230);
